...
function Datastore() {
  ...
  console.log(process.env.DATASTORE_LOCAL_HOST);

  var self = {};

  self.creds = {
    projectId: process.env.GCLOUD_PROJECT || process.env.DATASTORE_PROJECT_ID
  };

  self.namespace = process.env.DATASTORE_NAMESPACE || 'local-dev';
